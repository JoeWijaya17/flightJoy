            ...
            <div class="flex gap-5 items-center">
                <div class="grid grid-cols-4 items-center rounded-[20px] border border-[#E8EFF7]">
                    <div id="Departure"
                        ...
                        <button type="button"
                            class="flex gap-4 items-center p-5 dropdown first:pl-6 first:border-l-0 last:pr-6 last:border-r-0"
                    ...
                    <div id="Arrival"
                        class="dropdown-container relative flex items-center h-full border-r border-[#E8EFF7] last:border-r-0">
                        <button type="button" class="flex gap-4 items-center p-5 dropdown first:pl-6 last:pr-6"
                    ...
                    <div id="Date"
                        ...
                        <button type="button" id="Date-Button"
                            class="flex relative gap-4 items-center p-5 first:pl-6 last:pr-6">
                            <img src="assets/images/icons/departure.svg" class="w-[50px] flex shrink-0" alt="icon">
                            <div class="text-left">
                    ...
                    <div id="Quantity"
                        ...
                        <div id="Quantity-Dropdown" class="hidden absolute top-full z-10 mt-4 dropdown-content">
